...
namespace MaterialUI
{
  ...
  public class Meta
  {
    ...
    public Meta()
    {
      ...
      Website = "https://github.com/dohwadev/MaterialUI-Accent";
  ...
  {
    public const string repoMaster = "dohwadev/MaterialUI";
    public const string repoAccent = "dohwadev/MaterialUI-Accent";
